...
\begin{matrix}
\ifact(c_0) & \ifact(c_0+1) & \cdots & \ifact(c_0+k-1) \\
\ifact(c_1-1) & \ifact(c_1) & \cdots & \ifact(c_1+k-2) \\
...
\ifact(c_0) & \ifact(c_0+1) & \cdots & \ifact(c_0+k-1) \\
\vdots & \vdots & \ddots & \vdots \\
-i\ifact(c_i-i) & (1-i)\ifact(c_i - i + 1) & \cdots & (k-i-1) \ifact(c_i+k-i-1) \\
\vdots & \vdots & \ddots & \vdots \\
\ifact(c_k-k) & \ifact(c_k-k+2) & \cdots & \ifact(c_k-1) \\
\end{matrix} \right|
$$
\end{definition}
