...
TODO(mikemeko): need to be careful for the $T(n,n)$  case.

In the inductive step, we assume that the equality holds for $T(m-1,n)$ and $T(m,n-1)$ and we show that it also hold for $T(m,n)$ using the recurrence given in Equation \ref{eqn:2-recurrence}.
\begin{align*}
